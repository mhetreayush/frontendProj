...
<form className="flex items-center drop-shadow-lg">   
    ...
    <div className="relative w-full">
        ...
        <input type="text" id="simple-search" className="bg-gray-150 border  border-gray-300 text-gray-900 text-sm rounded-lg block w-full pl-2" placeholder="SEARCH" required="" />
    </div>
</form>
)
}
