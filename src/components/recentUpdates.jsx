const RecentUpdates = () =>{
    return(
        <div className="fixed px-3 h-min">
            <div className="w-full flex flex-col gap-y-3">
                <div className="flex w-full justify-between items-center">
                    <div className="flex gap-x-2 items-center">
                    <img className="w-full h-full" src={require("./Icons/notifications.png")} />
                    <img className="w-full h-full" src={require("./Icons/bell.png")} />
                    </div>
                    <img src={require("./Profiles/Ayush.png")} />
                </div>
                <h1 className="font-bold">Recent Updates</h1>
                ...
                <a className="underline decoration-dotted">See all</a>
                <hr />
                <h1 className="font-bold">Post</h1>
                <div className="bg-white rounded-md flex flex-col gap-y-3 px-2 py-3">
